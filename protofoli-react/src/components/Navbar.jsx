...
import {FaBars, FaTimes,FaGithub,FaLinkedin,FaSignature} from 'react-icons/fa';
...
const Navbar = () => {
  ...
  return (
    <div className='fixed w-full h-[80px] flex justify-between items-center px-4 bg-[#0a192f] text-gray-300'>
       <div>
          <img src={pa1} alt="pa1 Image" style={{width: '50px'}}></img>  
           {/* <h1 className='text-5xl font-bold font-signature ml-2'>Pavani</h1>   */}
       </div>
       {/* menu */}
      ...
      Contact
       ...
       {/* Hamburger */}
       <div onClick={handleClick} className='md:hidden z-10 top-0 right-0'>
        {!nav ?<FaBars/>: <FaTimes/>}
       </div>
       {/* Mobile Menu */}
